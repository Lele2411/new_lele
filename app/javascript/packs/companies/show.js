$(function() {
    preventEnter($("#company_company_code"), [6], $("#company_code_error"), "#company_code_error_detail", "<div id='company_code_error_detail'>Company code must have 6 characters!</div>");
    preventEnter($("#company_phone_number"), [10, 11], $("#phone_number_error"), "#phone_number_error_detail", "<div id='phone_number_error_detail'>Phone number must have 10 or 11 characters!</div>");
